...
public final class Result<T, E> {
     ...
     * callers may use this method to coerce a success state to an error state.
     */
    ...
    /**
     * Returns the value of result or throws an {@link IllegalStateException} if no result.
     *
